...
public class ReserveItem {
    ...
    public static void reserveItem(
            Activity activity,
            int User_Id,
            int Item_Id
    ) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, requestUrls.getInstance().ReserveItem, parameters, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (result) {
                        Log.wtf("reserved", "result true " + response.toString());
